    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-font-smoothing: antialiased; }
        ...
        @media (max-width: 768px) {
            ...
            .hero-names { font-size: 2rem; letter-spacing: 4px; }
            .hero-date { font-size: 11px; letter-spacing: 3px; }
            .hero-phrase { font-size: 1rem; }

            /* COUNTDOWN */
            .countdown-section { padding: 60px 15px; }
            .cd-wrapper { gap: 10px; max-width: 100%; }
            .cd-num { font-size: 28px; }

            /* FAMILIA */
            .familia-grid { grid-template-columns: 1fr; gap: 30px; padding: 60px 5%; }
            .padrinos-container { grid-column: span 1; }
            .padrino-item { display: block; width: 100%; margin: 8px 0; }
            .parent-name { font-size: 18px; }

            /* EVENTOS */
            .event-card { flex-direction: column; max-width: 100%; margin: 20px 15px; box-shadow: 8px 8px 0px var(--color-primary); }
            .event-img { width: 100%; height: 220px; }
            .event-info { padding: 30px 20px; }

            /* VESTIMENTA */
            .dress-code-section { clip-path: polygon(0 5%, 100% 0, 100% 95%, 0 100%); padding: 80px 20px; }
            .dress-code-section h2 { font-size: 24px; }

            /* ITINERARIO */
            .itinerary-section { padding: 60px 5%; }
            .itin-item { gap: 15px; margin-bottom: 30px; }
            .itin-time { font-size: 20px; min-width: 80px; }
            .itin-icon { font-size: 18px; }
            .itin-name { font-size: .75rem; letter-spacing: 1px; }

            /* GALERÍA */
            .gal-dynamic { grid-template-columns: 1fr 1fr; gap: 8px; padding: 10px; }
            .gal-dynamic img { height: 180px; }

            /* RSVP */
            .rsvp-section { padding: 60px 15px; }
            .gold-btn { padding: 12px 25px; font-size: 11px; }
        ...
        @media (max-width: 480px) {
            ...
            .cd-wrapper { grid-template-columns: repeat(2, 1fr); max-width: 280px; }
            .gal-dynamic { grid-template-columns: 1fr; }
            .gal-dynamic img { height: 250px; }
            .familia-grid { padding: 40px 5%; }
            .dress-code-section h2 { font-size: 20px; }
        }
    </style>
</head>
<body>
    ...
    <section class="familia-grid fade-in">
        ...
        <div data-section="padrinos" class="padrinos-container">
    ...
    <section class="eventos-section">
        ...
        <div data-section="segunda_sede" class="event-card fade-in" style="box-shadow: -20px 20px 0px var(--color-secondary);">
            <div class="event-info">
    ...
    <section class="itinerary-section" data-section="itinerario">
    ...
    <section class="galeria-section" data-section="galeria">
