    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .hero-names { font-size: clamp(1.8rem, 8vw, 3rem); }
            .hero-date { font-size: 13px; letter-spacing: 3px; }

            /* COUNTDOWN */
            .countdown { padding: 50px 15px; gap: 10px; flex-wrap: wrap; justify-content: center; }
            .cd-box { min-width: 70px; padding: 15px 10px; }
            .cd-num { font-size: 2rem; }

            /* FAMILIA */
            .family { grid-template-columns: 1fr; gap: 30px; padding: 60px 5%; }
            .family-card { padding: 25px 20px; }

            /* EVENTOS */
            .itin-item { flex-direction: column; gap: 8px; }
            .itin-time { min-width: auto; font-size: 1rem; }
            .itin-body { padding-left: 0; border-left: none; border-top: 1px solid var(--color-secondary); padding-top: 10px; }

            /* VESTIMENTA */
            section[style*="background: var(--color-text)"] { padding: 60px 5%; }
            ...
            /* BOTONES */
            .btn-magic { padding: 14px 25px; font-size: 0.75rem; letter-spacing: 2px; width: 100%; text-align: center; }
        ...
        @media (max-width: 480px) {
            .hero-names { font-size: 1.6rem; letter-spacing: 2px; }
            .cd-box { min-width: 60px; padding: 12px 8px; }
            .cd-num { font-size: 1.6rem; }
            .gallery { grid-template-columns: 1fr; }
            .gal-item { height: 240px; }
            .family { padding: 40px 5%; }
        }
    </style>
</head>
<body>
    ...
    <section class="countdown fade-in">
        <div class="cd-box">
            ...
            <span class="cd-label"><span data-es>Días</span><span data-bilingual style="display:none;">Days</span></span>
        </div>
        <div class="cd-box">
            <span class="cd-num" id="cd-horas">--</span>
            <span class="cd-label"><span data-es>Horas</span><span data-bilingual style="display:none;">Hours</span></span>
        </div>
        <div class="cd-box">
            <span class="cd-num" id="cd-min">--</span>
            <span class="cd-label"><span data-es>Minutos</span><span data-bilingual style="display:none;">Minutes</span></span>
        </div>
        <div class="cd-box">
            <span class="cd-num" id="cd-seg">--</span>
            <span class="cd-label"><span data-es>Segundos</span><span data-bilingual style="display:none;">Seconds</span></span>
        </div>
    </section>
    ...
    <section class="family">
        <div class="family-card fade-in">
            <h2 style="font-family: var(--font-titulos); margin-bottom: 20px; color: var(--color-primary); font-size: 1.1rem;"><span data-es>Padres de la Novia</span><span data-bilingual style="display:none;">Bride's Parents</span></h2>
        ...
        <div class="family-card fade-in" style="border-left: 0; border-right: 4px solid var(--color-primary); text-align: right;">
            <h2 style="font-family: var(--font-titulos); margin-bottom: 20px; color: var(--color-primary); font-size: 1.1rem;"><span data-es>Padres del Novio</span><span data-bilingual style="display:none;">Groom's Parents</span></h2>
            <p data-field="madre_novio">Sra. Margarita Robles</p>
            <p data-field="padre_novio">Sr. Victor Manuel Méndez</p>
        </div>
        <div data-section="padrinos" class="fade-in" style="grid-column: 1 / -1; text-align: center; margin-top: 50px;">
            <h3 style="font-family: var(--font-titulos); font-size: 1.8rem; margin-bottom: 24px;"><span data-es>Nuestros Padrinos</span><span data-bilingual style="display:none;">Our Sponsors</span></h3>
    ...
    <section class="itinerary">
        <h2 class="fade-in" style="font-family: var(--font-titulos); text-align: center; font-size: 2.5rem; margin-bottom: 60px;">
            <span data-es>Dónde y Cuándo</span><span data-bilingual style="display:none;">Where & When</span>
        </h2>
        
        <div class="itin-item fade-in">
            <div class="itin-time" data-field="hora_ceremonia">17:00 HRS</div>
            <div class="itin-body">
                <div class="itin-name"><span data-es>Ceremonia Religiosa</span><span data-bilingual style="display:none;">Religious Ceremony</span></div>
                ...
                ><span data-es>VER MAPA</span><span data-bilingual style="display:none;">VIEW MAP</span></a>
            </div>
        </div>

        <div class="itin-item fade-in" data-section="segunda_sede">
            <div class="itin-time" data-field="hora_recepcion">19:00 HRS</div>
            <div class="itin-body">
                <div class="itin-name">Recepción</div>
                <div data-field="lugar_recepcion" style="font-weight: 600; margin-bottom: 4px;"><span data-es>Jardín de los Espejos</span><span data-bilingual style="display:none;">Mirror Garden</span></div>
    ...
    <section class="vestimenta-section fade-in">
        <h2 style="font-family: var(--font-titulos); margin-bottom: 30px; font-size: 1.5rem;"><span data-es>Código de Vestimenta</span><span data-bilingual style="display:none;">Dress Code</span></h2>
        ...
        <div style="margin-top: 20px; display: flex; justify-content: center; gap: 40px; flex-wrap: wrap;">
            <div style="text-align: center;">
                <p style="font-size: .7rem; letter-spacing: .2em; text-transform: uppercase; opacity: .5; margin-bottom: .4rem;"><span data-es>Damas</span><span data-bilingual style="display:none;">Women</span></p>
                <p data-field="vestimenta_damas" style="font-family: var(--font-accent); font-style: italic; font-size: 1.1rem;">Vestido Largo</p>
            </div>
            <div style="text-align: center;">
                <p style="font-size: .7rem; letter-spacing: .2em; text-transform: uppercase; opacity: .5; margin-bottom: .4rem;"><span data-es>Caballeros</span><span data-bilingual style="display:none;">Men</span></p>
    ...
    <!-- ══════════════════════════════════════
         Solo Adultos (Posicionado más abajo)
    ═══════════════════════════════════════ -->
    <div class="adultos-banner" data-field="solo_adultos" style="display:none; text-align: center; margin: 40px auto; font-weight: bold; font-family: var(--font-titulos); letter-spacing: 2px; color: var(--color-primary); padding: 15px; border-top: 1px dashed var(--color-secondary); border-bottom: 1px dashed var(--color-secondary); max-width: 80%;">
    ...
    ═══════════════════════════════════════ -->
    <section class="itinerary" data-section="itinerario">
        <h2 class="fade-in" style="font-family: var(--font-titulos); text-align: center; font-size: 2rem; margin-bottom: 50px;">
            <span data-es>Nuestra Historia en Horas</span><span data-bilingual style="display:none;">Our Story in Hours</span>
        </h2>
    ...
    <!-- ══════════════════════════════════════
         8. GALERÍA
    ═══════════════════════════════════════ -->
    <section class="gallery" data-section="galeria" data-field="galeria_html">
    ...
    <section class="music-section" data-section="musica">
        <h3><span data-es>Nuestra Melodía</span><span data-bilingual style="display:none;">Our Melody</span></h3>
        <p data-field="music_url" style="font-style: italic; color: #666; margin-bottom: 20px;"></p>
        <button class="btn-play btn-magic" onclick="toggleMusic()"><span data-es>▶ REPRODUCIR</span><span data-bilingual style="display:none;">▶ PLAY</span></button>
        <audio id="audio-player" preload="none"></audio>
    </section>

    <!-- REGALOS -->
    <section class="regalos-section" data-section="regalos">
        <h2 style="font-family: var(--font-titulos); margin-bottom: 16px;"><span data-es>Mesa de Regalos</span><span data-bilingual style="display:none;">Gift Table</span></h2>
    ...
    <section data-section="firmas" style="display:none; padding: 80px 10%; text-align: center; background: #fdfdfd;">
        <h2 style="font-family: var(--font-titulos); margin-bottom: 30px; font-size: 1.5rem;"><span data-es>Libro de Firmas</span><span data-bilingual style="display:none;">Guest Book</span></h2>
        <div style="max-width: 550px; margin: 0 auto; display: flex; flex-direction: column; gap: 1rem;">
            <input type="text" id="firma-nombre" placeholder="Tu nombre" data-field="label_name" style="padding: 1rem 1.5rem; border: 1px solid var(--color-primary); font-family: var(--font-cuerpo); font-size: .95rem; outline: none; background: white;">
    ...
    <section class="rsvp fade-in">
        <h2 style="font-family: var(--font-titulos); font-size: 2.5rem; margin-bottom: 16px;"><span data-es>¿Nos acompañas?</span><span data-bilingual style="display:none;">Will you join us?</span></h2>
        <p style="margin-bottom: 8px; color: #666;"><span data-es>Favor de confirmar antes del:</span><span data-bilingual style="display:none;">Please confirm before:</span></p>
        <p 
        ...
        <a 
            ...
            rel="noopener noreferrer"
            class="btn-magic"
        ><span data-es>CONFIRMAR POR WHATSAPP</span><span data-bilingual style="display:none;">CONFIRM VIA WHATSAPP</span></a>
    ...
    window.addEventListener('message',(e)=>{
        ...
        if(d.sections_styles){
            ...
            if(s.font_titulos||s.font_cuerpo||s.font_accent){
                const fonts=[s.font_titulos,s.font_cuerpo,s.font_accent].filter(Boolean).map(f=>f.replace(/ /g,'+')).join('&family=');
                ...
                lk.href='https://fonts.googleapis.com/css2?family='+fonts+':ital,wght@0,300;0,400;0,700;1,400&display=swap';
                document.head.appendChild(lk);
                lk.onload=()=>{
                    if(s.font_titulos)r.style.setProperty('--font-titulos',"'"+s.font_titulos+"', serif");
                    if(s.font_cuerpo)r.style.setProperty('--font-cuerpo',"'"+s.font_cuerpo+"', sans-serif");
                    if(s.font_accent)r.style.setProperty('--font-accent',"'"+s.font_accent+"', cursive");
                };
            }
            if(s.animaciones){
        ...
        const fieldShow = (field, condition) => {
            document.querySelectorAll('[data-field="' + field + '"]').forEach(el => {
                const wrapper = el.closest('[data-section-field]');
                if (wrapper) {
                    wrapper.style.display = condition ? '' : 'none';
                } else {
