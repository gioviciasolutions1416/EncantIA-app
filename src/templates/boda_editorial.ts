    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-font-smoothing: antialiased; }
        ...
        @media (max-width: 768px) {
            /* HERO */
            .hero { flex-direction: column; overflow-y: auto; height: auto; min-height: 100vh; padding: 0; }
            .hero-img-container { width: 100%; height: 45vh; position: relative; top: auto; clip-path: none; }
            .hero-content { width: 100%; padding: 40px 20px; text-align: center; }
            .hero-names { font-size: clamp(2rem, 9vw, 4rem); line-height: 1; }
            .hero-date { font-size: 1.1rem; }

            /* FAMILIA */
            .familia-section { grid-template-columns: 1fr; gap: 30px; padding: 60px 5%; }
            .familia-block { text-align: center; }
            .parents-grid { margin-bottom: 20px; }

            /* EVENTOS */
            .eventos-section { padding: 60px 5%; }
            .eventos-grid { grid-template-columns: 1fr; gap: 20px; }
            .evento-card { padding: 35px 25px; box-shadow: 8px 8px 0px var(--color-bg); }

            /* VESTIMENTA */
            .vestimenta-section { padding: 60px 5%; }
            .vestimenta-icons { flex-direction: column; gap: 25px; align-items: center; }

            /* ITINERARIO */
            .itin-container { padding: 60px 5%; }
            .itin-item { flex-direction: column; gap: 8px; margin-bottom: 30px; }
            .itin-time { width: auto; font-size: 1.1rem; }
            .itin-body { padding-left: 0; border-left: none; border-top: 1px solid var(--color-primary); padding-top: 10px; }
            ...
            /* RSVP */
            .rsvp-card { padding: 35px 20px; }
            .btn-gold { width: 100%; text-align: center; padding: 14px 20px; }
        }

        @media (max-width: 480px) {
            .hero-names { font-size: 1.8rem; }
            .gal-dynamic { grid-template-columns: 1fr; }
            .gal-dynamic img { grid-row: span 1 !important; height: 220px; }
            .familia-section { padding: 40px 5%; }
            .eventos-grid { gap: 15px; }
            .evento-card { padding: 25px 15px; }
        }
    </style>
</head>
<body>
